...
module.exports = Sorcerer = function(level) {
	if (level != null && global != null) {
		this.build(false, global.spriteId++, "Sorcerer", "Sorcerer", 10 + parseInt(level * 2.5), 10 + parseInt(level * 2.5), 90, 90, 0.05 + level/500.0, [ new FireBolt(null, 1 + parseInt(level/2)) ], level * 16);		

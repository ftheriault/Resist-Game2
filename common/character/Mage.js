...
Mage.prototype.initPlayer = function (id, name) {
	this.build(true, id, name, "Mage", 60, 60, 90, 90, 0.05, [ new FireBolt(null, 1), new FireWell(null, 0), new FrostNova(null, 0), new Teleport(null, 0), new HealingPotion(null, 1) ]);
}

...
Hunter.prototype.initPlayer = function (id, name) {
	this.build(true, id, name, "Hunter", 90, 90, 50, 50, 0.07, [ new Shoot(null, 0), new ExplosiveArrow(null, 0), new MultipleShots(null, 0), new FireTrap(null, 0), new SwiftAura(null, 0), new HealingPotion(null, 1) ]);
}

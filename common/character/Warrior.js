...
Warrior.prototype.initPlayer = function (id, name) {
	this.build(true, id, name, "Warrior", 110, 110, 10, 10, 0.07, [ new Slash(null, 1), new Sacrifice(null, 0), new Spin(null, 0), new ProtectionShield(null, 0), new DefenseAura(null, 0), new HealingPotion(null, 1) ]);
}
